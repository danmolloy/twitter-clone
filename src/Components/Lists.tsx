...
export const Lists = () => {
  return (
    <div className="border-r w-full mr-2">
      <div className="flex flex-row border-b w-full flex flex-row justify-between items-center">
        <div className="flex flex-row">
          ...
          <div className="ml-4 mt-2">
            ...
            <p className="pl-2 -pt-2 text-xs text-gray-600 mb-1.5">@dan_molloy1</p>
          </div>
        </div>
