  ...
  return (
    <div className="border-r w-full mr-2">
      <div className="border-b flex flex-row">
        ...
        <p className="text-sm text-gray-600 -mt-1">6 tweets</p>
        </div>
      </div>
      ...
      <div className="w-full h-3/5 ">
        ...
        <button className="font-bold border border-gray-300 rounded-full py-1 px-2 my-4 mr-4">Edit Profile</button>
        </div>
        <div className="flex flex-col w-2/5 ml-12">
          <h3 className="font-bold text-xl">Dan Molloy</h3>
          <p className="text-gray-600 text-sm">@dan_molloy1</p>
          <p className="my-2">musician</p>
          <div className="flex flex-row text-gray-600">
            <CalendarIcon className="w-6 h-auto -ml-1" />
            <p className="ml-1">Joined November 2020</p>
          </div>
          <div className="flex flex-row text-gray-600 my-2">
            <p><span className="font-bold text-black">37</span> following</p>
            <p className="ml-2 text-black"><span className="font-bold">10</span> followers</p>
          </div>
        </div>
