...
export const TweetComments = (props: any) => {
  ...
  return (
    <div className="flex flex-col border bg-white w-full p-4 sm:w-4/5 fixed h-3/4 sm:h-1/2 -mt-48 rounded-lg shadow-md">
      ...
      <div className="flex flex-row mt-4 py-4 justify-between items-center border-b border-t">
